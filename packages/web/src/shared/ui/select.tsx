...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "lma-relative lma-flex lma-w-full lma-cursor-default lma-select-none lma-items-center lma-rounded-sm lma-py-1.5 lma-pl-8 lma-pr-2 lma-text-sm outline-none data-[disabled]:lma-pointer-events-none data-[disabled]:lma-opacity-50 focus:lma-bg-accent focus:lma-text-accent-foreground",
      className,
    )}
    {...props}
  >
